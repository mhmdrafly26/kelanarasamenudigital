    ...
    <div class="space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 font-medium">Ringkasan performa penjualan dan arus kas KELANA RASA Space.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-50">
                        <p class="text-[11px] text-gray-500 font-medium leading-relaxed italic">
                            "Data mencakup performa penjualan harian KELANA RASA Space berdasarkan status transaksi yang berhasil."
                        </p>
                    </div>
                </div>
            </div>
