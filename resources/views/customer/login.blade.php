...
<head>
    ...
    <title>KELANA RASA | Masuk E-Menu</title>
...
<div class="flex items-center justify-center gap-3 mb-10">
    ...
    <div class="text-left">
        <h1 class="text-3xl font-black italic tracking-tighter uppercase leading-none text-[#080d1a]">
            KELANA RASA
        </h1>
        <p class="text-[10px] font-black text-blue-600 uppercase tracking-widest mt-2">
            E-Menu System
        </p>
    </div>
</div>
