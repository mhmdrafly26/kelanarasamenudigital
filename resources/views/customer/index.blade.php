...
<head>
    ...
    <title>KELANA RASA Digital Menu</title>
...
<a href="{{ route('customer.index') }}" class="header-animate flex items-center gap-3 hover:opacity-70 transition-opacity">
    <img
        src="{{ asset('images/logo.png') }}"
        alt="Logo Kelana Rasa"
        class="w-20 h-20 object-contain"
    >

    <div>
        <h1 class="text-xl font-black italic tracking-tighter uppercase leading-none text-[#080d1a]">
            KELANA RASA
        </h1>

        <p class="text-[9px] font-bold text-blue-600 uppercase tracking-widest mt-1">
            #KelanaRasaTasikmalaya<br>
            Open 16.00 WIB - 00.00 WIB<br>
            📍Jl Pemuda, Available on: [ShopeeFood] [GrabFood]
        </p>
    </div>
</a>
    ...
    <div id="drawer-panel" class="fixed inset-y-0 left-0 w-80 bg-white z-[251] shadow-2xl p-8 flex flex-col justify-between transform -translate-x-full transition-transform duration-500 ease-out rounded-r-[2.5rem]">
        <div>
            ...
            <div class="flex justify-between items-center mb-10">
                <h3 class="text-xs font-black uppercase text-gray-400 tracking-[0.2em]">KELANA RASA Space Menu</h3>
    ...
    <div id="history-sheet" class="fixed bottom-0 inset-x-0 bg-white rounded-t-[3.5rem] z-[301] bottom-sheet p-10 lg:max-w-md lg:mx-auto max-h-[80vh] overflow-y-auto shadow-[0_-20px_50px_rgba(0,0,0,0.1)]">
        ...
        <p class="text-xs font-medium text-gray-400 mb-8">Daftar pesanan Anda di restoran KELANA RASA Space.</p>
