...
<head>
    ...
    <title>KELANA RASA Space - Menu</title>
...
<body class="bg-gray-50 antialiased">
    ...
    <nav class="bg-white shadow-sm p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <h1 class="text-2xl font-bold text-blue-600">KELANA RASA Space</h1>
            @if (Route::has('login'))
                <div>
                    @auth
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            @else
                <div class="col-span-full text-center py-20 bg-white rounded-2xl border-2 border-dashed">
                    <p class="text-gray-400">Selamat datang di KELANA RASA Space! Menu sedang disiapkan.</p>
                </div>
            @endif
        </div>
    </main>
